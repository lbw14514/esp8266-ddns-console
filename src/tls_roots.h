...
// ISRG Root X1
const char TLS_ROOT_ISRG_X1[] PROGMEM = R"PEM(
-----BEGIN CERTIFICATE-----
...
// GTS Root R4
const char TLS_ROOT_GTS_R4[] PROGMEM = R"PEM(
-----BEGIN CERTIFICATE-----
...
const char TLS_ROOT_DIGICERT_G2[] PROGMEM = R"PEM(
-----BEGIN CERTIFICATE-----
...
// Amazon Root CA 1
const char TLS_ROOT_AMAZON_CA1[] PROGMEM = R"PEM(
-----BEGIN CERTIFICATE-----
...
const char TLS_ROOT_GLOBALSIGN_R3[] PROGMEM = R"PEM(
-----BEGIN CERTIFICATE-----
